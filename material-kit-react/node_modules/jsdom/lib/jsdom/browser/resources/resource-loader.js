...
const dataURLFromRecord = require("jsdom/lib/jsdom/browser/resources/node_modules/data-urls").fromURLRecord;
const request = require("jsdom/lib/jsdom/browser/resources/node_modules/request-promise-native");
const wrapCookieJarForRequest = require("jsdom/lib/jsdom/living/helpers/wrap-cookie-jar-for-request");
