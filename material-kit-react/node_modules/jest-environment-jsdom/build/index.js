...
function _jestUtil() {
  const data = require('jest-environment-jsdom/build/node_modules/jest-util');
...
function _jestMock() {
  const data = require('jest-environment-jsdom/build/node_modules/jest-mock');
...
function _fakeTimers() {
  const data = require('jest-environment-jsdom/build/node_modules/@jest/fake-timers');
...
function _jsdom() {
  const data = require('jest-environment-jsdom/build/node_modules/jsdom');
